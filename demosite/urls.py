...
from .views import home_view, login_view, register_view, logout_view, api_data_view, api_data_view_2, api_data_view_4, api_data_view_5, tickers_view
...
urlpatterns = [
    ...
    path('tickers/', tickers_view, name='tickers'),
